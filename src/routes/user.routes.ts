...
router.route("/avatar").patch(isAuthenticated,upload.single("avatar"),updateAvatar);
router.route("/cover-image").patch(isAuthenticated,upload.single("coverImage"),updateCoverImage);
